...
class TextInputDialog(ModernDialogBase):
    def __init__(self, parent=None, title="Nuevo usuario", label=""):
        super().__init__(parent, title)
...
def ask_text(parent, title: str, label: str, default: str = "") -> tuple[bool, str]:
    dlg = TextInputDialog(parent, title=title, label=label)
